package net.arkamc.arkacore.bukkit.expansion.player;
...
public class PlayerPlaceholderExpansion {
    ...
    public void register() {
        ...
        HookManager.addPlaceholder("player_credit", this::getCredit);
    }
     ...
     */
    private String getCredit(Player paramPlayer) {
        PlayerData paramPlayerData = ApiImplementation.getInstance().getPlayerManager().getPlayerData(paramPlayer.getUniqueId());
        if (paramPlayerData.isLoaded()) {
            return String.valueOf(paramPlayerData.getCredit());
        }
