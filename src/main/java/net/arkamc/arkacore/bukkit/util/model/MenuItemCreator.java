...
import net.arkamc.arkacore.bukkit.settings.StsCreditMenu;
...
public final class MenuItemCreator {
    ...
    public static MenuItemCreator fromItemStack(ItemStack itemStack) {
        ...
        if (StsCreditMenu.ImmutableContent.getCache().containsKey(uniqueId)) {
            return StsCreditMenu.ImmutableContent.getCache().get(uniqueId);
        } else if (StsCreditMenu.Content.getCache().containsKey(uniqueId)) {
            return StsCreditMenu.Content.getCache().get(uniqueId);
        }
    ...
    public static MenuItemCreator fromKey(String key) {
        return Stream.concat(StsCreditMenu.ImmutableContent.getCache().values().stream(),
                        StsCreditMenu.Content.getCache().values().stream())
