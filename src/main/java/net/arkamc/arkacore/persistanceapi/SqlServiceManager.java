package net.arkamc.arkacore.persistanceapi;
...
import net.arkamc.arkacore.persistanceapi.datamanager.PlayerManager;
...
public class SqlServiceManager {
     ...
     * @return           Le PlayerBean du joueur
     */
    public synchronized PlayerBean getPlayer(String playerName) {
        return this.playerManager.getPlayer(playerName, null);
    }
     ...
     * @param callback   Le callback de PlayerBean
     */
    public synchronized void getPlayer(String playerName, Callback<PlayerBean> callback) {
        this.playerManager.getPlayer(playerName, callback);
    }
