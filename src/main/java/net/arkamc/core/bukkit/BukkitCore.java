...
import net.arkamc.core.bukkit.commands.CreditCommand;
import net.arkamc.core.bukkit.expansion.player.PlayerPlaceholderExpansion;
import net.arkamc.core.bukkit.expansion.server.ServerPlaceholderExpansion;
import net.arkamc.core.bukkit.listeners.general.GlobalJoinListener;
import net.arkamc.core.bukkit.listeners.pubsub.GlobalUpdateListener;
import net.arkamc.core.bukkit.player.DataPlayerManager;
import net.arkamc.core.bukkit.settings.Settings;
import net.arkamc.core.jedis.DatabaseConnector;
import net.arkamc.core.jedis.RedisServer;
...
public class BukkitCore extends SimplePlugin {
    ...
    private void initializeFields() {
        ...
        this.dataPlayerManager = new DataPlayerManager(this.api);
