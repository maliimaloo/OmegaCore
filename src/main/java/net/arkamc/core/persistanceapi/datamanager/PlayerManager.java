package net.arkamc.core.persistanceapi.datamanager;
...
import net.arkamc.core.persistanceapi.database.MResultSet;
import net.arkamc.core.persistanceapi.utils.Transcoder;
...
public class PlayerManager {
    ...
    public void updatePlayer(PlayerBean playerBean, Callback<Integer> callback) {
        ...
        }, playerBean.getName(), playerBean.getCredit(), playerBean.getLastLogin().toString(), playerBean.getLastIp(), playerBean.getGroupId(), playerBean.getNickname(), Transcoder.encode(playerBean.getUniqueId().toString()));
    }
