package net.omegagames.core.persistanceapi.beans.credit;
...
public class CreditBean {
    ...
    */
    ...
    public String toString() {
        return this.getTimestamp().toString() + "," + this.getType() + "," + this.getSender() + "," + this.getReceiver() + "," + this.getAmount() + "," + this.getReason();
    }
