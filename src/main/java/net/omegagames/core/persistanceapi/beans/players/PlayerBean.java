...
public class PlayerBean {
    ...
    */
    ...
    @Getter
    private static String fieldOmega = "omega";
    @Getter
    ...
    // Constructor
    public PlayerBean(UUID uniqueId, String name, String nickName, int omega, Timestamp lastLogin, Timestamp firstLogin, String lastIP, long groupId, List<CreditBean> creditLogs) {
